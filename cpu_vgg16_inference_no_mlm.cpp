...
void vgg16_net(){
    ...
    uint32_t n_fwd = 0;
    dnnl_primitive_t net_fwd[53];
    args_t net_fwd_args[53];
...
//     dnnl_dims_t conv2_user_src_sizes = { BATCH, 64, 224, 224 };
    ...
    float *conv2_weights = (float *)malloc(
                product(conv2_user_weights_sizes, ndims) * sizeof(float));
    float *conv2_bias
    ...
    float *conv3_weights = (float *)malloc(
                product(conv3_user_weights_sizes, ndims) * sizeof(float));
    float *conv3_bias
    ...
    float *conv4_weights = (float *)malloc(
                product(conv4_user_weights_sizes, ndims) * sizeof(float));
    float *conv4_bias
            = (float *)malloc(product(conv4_bias_sizes, 1) * sizeof(float));
    ...
    float *conv5_weights = (float *)malloc(
                product(conv5_user_weights_sizes, ndims) * sizeof(float));
    float *conv5_bias
            = (float *)malloc(product(conv5_bias_sizes, 1) * sizeof(float));
    ...
    float *conv6_weights = (float *)malloc(
                product(conv6_user_weights_sizes, ndims) * sizeof(float));
    float *conv6_bias
            = (float *)malloc(product(conv6_bias_sizes, 1) * sizeof(float));
    ...
    float *conv7_weights = (float *)malloc(
                product(conv7_user_weights_sizes, ndims) * sizeof(float));
    float *conv7_bias
            = (float *)malloc(product(conv7_bias_sizes, 1) * sizeof(float));
    ...
    float *conv8_weights = (float *)malloc(
                product(conv8_user_weights_sizes, ndims) * sizeof(float));
    float *conv8_bias
            = (float *)malloc(product(conv8_bias_sizes, 1) * sizeof(float));
    ...
    float *conv9_weights = (float *)malloc(
                product(conv9_user_weights_sizes, ndims) * sizeof(float));
    float *conv9_bias
            = (float *)malloc(product(conv9_bias_sizes, 1) * sizeof(float));
    ...
    float *conv10_weights = (float *)malloc(
                product(conv10_user_weights_sizes, ndims) * sizeof(float));
    float *conv10_bias
            = (float *)malloc(product(conv10_bias_sizes, 1) * sizeof(float));
    ...
    float *conv11_weights = (float *)malloc(
                product(conv11_user_weights_sizes, ndims) * sizeof(float));
    float *conv11_bias
            = (float *)malloc(product(conv11_bias_sizes, 1) * sizeof(float));
    ...
    float *conv12_weights = (float *)malloc(
                product(conv12_user_weights_sizes, ndims) * sizeof(float));
    float *conv12_bias
            = (float *)malloc(product(conv12_bias_sizes, 1) * sizeof(float));
    ...
    float *conv13_weights = (float *)malloc(
                product(conv13_user_weights_sizes, ndims) * sizeof(float));
    float *conv13_bias
            = (float *)malloc(product(conv13_bias_sizes, 1) * sizeof(float));
    ...
    // allocate src, weight, bias, dst
    float *fc2_weights = (float*)malloc(product(fc2_weights_sizes, ndims) * sizeof(float));
    float *fc2_bias = (float*)malloc(product(fc2_bias_sizes, 1)*sizeof(float));
    // initialiaze weight, bias
    ...
    // allocate src, weight, bias, dst
    float *fc3_weights = (float*)malloc(product(fc3_weights_sizes, ndims) * sizeof(float));
    float *fc3_bias = (float*)malloc(product(fc3_bias_sizes, 1)*sizeof(float));
    // initialiaze weight, bias
